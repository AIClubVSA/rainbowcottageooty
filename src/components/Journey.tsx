  ...
  return (
    <section ref={root} className="journey relative h-[520vh] bg-[#153a30] text-cream" aria-label="Your journey to Rainbow Cottages">
      <div className="sticky top-0 h-svh overflow-hidden">
        ...
        <div ref={bus} className="absolute top-[62%] right-[5%] z-20 h-20 w-72 overflow-hidden rounded-[1.75rem] bg-[#f8f3e8] p-2 shadow-2xl sm:top-[21%] sm:right-[8%] sm:h-24 sm:w-[22rem]" data-cursor="journey">
          <img src="/images/bus.gif" alt="A bus travelling along the road to Rainbow Cottages" className="pointer-events-none h-full w-full object-contain" />
        </div>
